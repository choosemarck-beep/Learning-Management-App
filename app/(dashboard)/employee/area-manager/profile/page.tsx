...
export default async function AreaManagerProfilePage({
  searchParams,
}: PageProps) {
  ...
  // If admin/regional manager is viewing, use the id from query params
  if (
    ...
    // Area Managers view their own profile
  ...
  // Only allow viewing AREA_MANAGER profiles
